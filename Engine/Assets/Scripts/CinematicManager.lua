    ...
    _G.PlayStatueCinematic = function(statueId)
        ...
        if statueId == "Circle" then
            track = {
                ...
                { time = 4.99, pos = { 86.162, 24.024, -339.759 }, rot = { 0, -1.465, 0 } },
                
                -- HARD CUT Portal
                { time = 5.00, pos = { 96.217, 19.671, -144.390 }, rot = { -31.169, 0, 0 } },
        ...
        elseif statueId == "Arch" then
            track = {
                ...
                { time = 4.99, pos = { 40.211, 20.273, -217.416 }, rot = { 0, -36.076, 0 } }, 
        ...
        elseif statueId == "T" then
            track = {
                ...
                { time = 4.99, pos = { 154.742, 8.695, -209.378 }, rot = { -180, -88.906, 180 } }, 
