...
function Start(self)
    ...
    _G.PlayMaskCinematic = function(maskName)
        if maskName == "Apolo" then
            local track = {
                { time = 0.0,  pos = { 201.246, 38.367, -172.199 }, rot = { 0, -0.094, 0 } },
                { time = 2.0,  pos = { 201.246, 38.136, -172.951 }, rot = { 0, -0.094, 0 } },
                { time = 3.0,  pos = { 201.246, 38.562, -171.778 }, rot = { 0, -0.094, 0 } },
                { time = 7.0,  pos = { 201.246, 38.562, -172.631 }, rot = { 0, -0.094, 0 } },
                { time = 8.0,  pos = { 201.246, 38.562, -172.631 }, rot = { 11.1, 24.996, 0 } },
                { time = 10.0, pos = { 201.246, 38.562, -172.631 }, rot = { 11.1, 24.996, 0 } },
                { time = 11.0, pos = { 197.172, 40.572, -171.960 }, rot = { -3.7, -23.552, 0 } },
                { time = 14.0, pos = { 196.692, 40.572, -170.849 }, rot = { -3.7, -23.552, 0 } },
                { time = 15.0, pos = { 201.001, 40.932, -171.411 }, rot = { -5.1, -21.327, 0 } },
                { time = 18.0, pos = { 201.001, 40.932, -171.411 }, rot = { -5.1, -21.327, 0 } },
                { time = 19.0, pos = { 201.001, 40.932, -171.411 }, rot = { -27.6, -21.327, 0 } },
                { time = 21.0, pos = { 201.001, 40.932, -171.411 }, rot = { -27.6, -21.327, 0 } },
                { time = 25.0, pos = { 194.841, 37.941, -173.308 }, rot = { -0.9, -30.673, 0 } },
                { time = 26.0, pos = { 193.905, 36.936, -176.291 }, rot = { 5.3, -73.973, 0 } },
                { time = 30.0, pos = { 193.905, 36.936, -176.291 }, rot = { 5.3, -73.973, 0 } }
            }
            SendTrackToCamera(track, 3.0)
